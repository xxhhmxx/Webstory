            ...
            <div id="center">
                ...
                <div id="spmoi"> 
                    ...
                    <?php
						...
						$sql = sprintf('select tentruyen, sotap, linkhinh, codep from product where codek="%s" or nguoidang="%s" limit %s, %s',$id,$id,$offset,$rowsPerPage);
					 ...
					 while ($row = mysql_fetch_array($result))
					  {
						  ...
						  ?>
                	<div class="sanpham">
                            <a href="chitiet.php?masp=<?=$row[3]?>&id=<?=$id?>">
                  ...
                  <?php
					...
					$sql = sprintf('select count(*) as numrows from product where (codek="%s" or nguoidang="%s")',$id,$id);		
					$result = DataProvider::executeQuery($sql);
