...
<body> 
	<div id="paperbg">
<div id="banner"><img id="banner" src="images/template/banner.png"/></div> 
<!-- khung banner-->
        <?php // chen code menu
        ...
        <div class="title_lr">Tài khoản</div>
            ...
            <div id="center">
                ...
                <div id="spmoi"> 
                	<div class="title_c">Truyện Tranh mới</div>
					...
					<?php
						...
						$sql = sprintf('select tentruyen, sotap, linkhinh, codep from product where hientrang = "Đang Tiến Hành" limit %s, %s',$offset,$rowsPerPage);
                	...
                	<div class="sanpham">
                            ...
                            <span class="tensp">
                            <strong><?=$row[0]?></strong>
							</span><a href="chitiet.php?masp=<?=$row[0]?>"><span><strong style="color:#F00">
                            <?=$row[1]?> tập
                            </strong></span></a></a>
                            <div class="muahang">
                                <a href="chitiet.php?masp=<?=$row[3]?>">
              ...
              <div id="spmoi">
              		<div class="title_c">Truyện Tranh nổi bật</div>
                	<?php
						//require('opendb.php');
						//require 'DataProvider.php';
						...
						$sql1 = sprintf('select tentruyen, sotap, linkhinh, codep from product where nguoidang = "Hảo" limit %s, %s',$offset1,$rowsPerPage1);
