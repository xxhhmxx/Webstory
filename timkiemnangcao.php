...
<body onload="inTable_lich();startTime();"> 
	<div id="paperbg">
        ...
        <div class="title_lr">Tài khoản</div>
          ...
          <span>          
         <form  name="timkiem" method="get" action="timkiemnc.php" style="display: inline-table">
    	<fieldset>
            
            <div class="divl">Nhập tên sản phẩm :<br /></div>
            <div>
            ...
            <div class="divl">Sản phẩm loại :<br /></div>
            <div>
