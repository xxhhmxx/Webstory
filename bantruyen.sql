...
('Arachnid', 'ECCHI', '13', 'Admin', 'Murata ShinyaIfuji Shinsen', 'Đang Tiến Hành', 'image/Arachnid.jpg', 'Ecchi 18+, Action, Horror, Adventure, ...','Arachnid'),
...
('Aria', 'ADVENTURE', '21', 'Hảo', 'Amano Kozue', 'Đang Tiến Hành', 'image/Aria.jpg', 'Adventure, Comedy, Fantasy, ....','Aria'),
('AsaMadeJugyouChu', 'HAREM', '24', 'Hảo', 'Ohta Akiyoshi, Munyu', 'Đang Tiến Hành', 'image/AsaMadeJugyouChu.jpg', 'Harem, Comedy, Ecchi 18+, ...','Asa Made Jugyou Chu'),
('AshitaNoKyouko-san', 'FANTASY', '7', 'Admin', 'Iwasaki Masakazu', 'Đang Tiến Hành', 'image/AshitaNoKyouko-san.jpg', 'Fantasy, Comedy, ...','Ashita No Kyouko-san'),
('AvengersVsX-men', 'FANTASY', '16', 'Admin', 'Marvel Comic', 'Đang Tiến Hành', 'image/AvengersVsX-men.jpg', 'Fantasy, Action, Adventure, ...','Avengers Vs X-men'),
...
('BabyPrincess', 'HAREM', '2', 'Admin', 'Kimino SakurakoMibu', 'Đamg Tiến Hành', 'image/BabyPrincess.jpg', 'Harem, Comedy, Ecchi, ...','Baby Princess'),
('BakaAndBoing', 'ECCHI', '22', 'Admin', 'Kobayashi Hiyoko', 'Đang Tiến Hành', 'image/BakaAndBoing.jpg', 'Ecchi 18+, Comedy, ...','Baka And Boing'),
('Bakekano', 'HAREM', '7', 'Hảo', 'Inoue Yukihiro', 'Đang Tiến Hành', 'image/BakeKano.jpg', 'Harem, Comedy, Ecchi 18+, ..','Bakekano'),
('BakuretsuTenshi', 'ECCHI', '7', 'Admin', 'GONZOMURAO Minoru', 'Tạm Ngưng', 'image/BakuretsuTenshi.jpg', 'Ecchi 18+, Action, ...','Bakuretsu Tenshi'),
('BananaNoNana', 'ECCHI', '1', 'Admin', 'Oniyazu Kakashi', 'Đang Tiến Hành', 'image/BananaNoNana.png', 'Ecchi 18+, Action, Adventure, Comedy, ...','Banana No Nana'),
...
('BbProject', 'MANHUA', '18', 'Hảo', 'Kaze', 'Đang Tiến Hành', 'image/BbProject.jpg', 'Manhua, Action, Comedy, ...','Bb Project'),
('BeeBeBeatIt', 'HAREM', '4', 'Hảo', 'Jinno Masak', 'Đang Tiến Hành', 'image/BeeBeBeatIt.jpg', 'Harem, Action, Comedy, Ecchi 18+, ...','Bee Be Beat It'),
('BinbougamiGa', 'FANTASY', '3', 'Admin', 'Sukeno Yoshiaki', 'Đang Tiến Hành', 'image/BinbougamiGa.jpg', 'Fantasy, Action, Comedy, ...','Binbougami Ga'),
...
('BlackGod-Kurokami', 'ECCHI', '82', 'Admin', 'Im Dal Young, Park Sung Woo', 'Đang Tiến Hành', 'image/BlackGod-Kurokami.jpg', 'Ecchi 18+, Action, Drama, ...','Black God - Kurokami'),
('BlackRockhooter-InnocentSoul', 'FANTASY', '9', 'Hảo', 'Suzuki Sanami', 'Đang Tiến Hành', 'image/BlackRockShooter-InnocentSoul.jpg', 'Fantasy, Action, ...','Black Rock Shooter - Innocent Soul'),
...
('Conan', 'ADVENTURE', '3 tập', 'Hảo', 'Gosho Aoyama', 'Đang Tiến Hành', 'image/Conan.jpg', 'Aventure, Comedy .....','Conan'),
...
('HiepKhachGiangHo', 'ADVENTURE', '2 tập', 'Hảo', 'Jun Gook Jin, Yang Jae Hyun', 'Đang Cập Nhập', 'image/HiepKhachGiangHo.jpg', 'Adventure, Action, Drama ...','Hiệp Khách Giang Hồ'),
...
('.hack//link', './image/hacklink/chap3','3'),
('.hack//link', './image/hacklink/chap4','4'),
('.hack//link', './image/hacklink/chap5','5'),
('Conan', './image/conan/chap1','1'),
('Conan', './image/conan/chap2','2'),
('Conan', './image/conan/chap3','3'),
('HiepKhachGiangHo', './image/HiepKhachGiangHo/chap1','1'),
('HiepKhachGiangHo', './image/HiepKhachGiangHo/chap2','2');
--
